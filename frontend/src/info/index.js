...
export { default as PaymentsFAQ } from './help/faq/payments';
export { default as BalanceHelp } from './help/faq/balance-help';
export { default as Contacts } from './help/contacts';
export { default as Support } from './help/support';
export { default as Payment } from './help/payment';
export { default as SayThanks } from './help/say-thanks';
